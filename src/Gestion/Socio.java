...
public class Socio implements Comparable<Socio> {
    ...
    /**
     * -1 es cuando el objeto que se está comparando es mayor que el objeto en
     * los argumentos 1 es cuando el objeto que se está comparando es menor que
     * el objeto en los argumentos
     *
    ...
    public static void sumaDNI(Socio s) {
        int resultado = 0;
        String Dni = s.DNI.substring(0, 7);
