...
public class Menu {
    ...
    /**
     * El objetivo de este metodo es que el usuario decida por cual atributo desea listar
     * @return  un numero que activará el switch desde la main para ejecutar un listado u otro
     */
